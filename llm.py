...
async def build_deep_style_analysis(
    ...
    prompt = (
        ...
        "диагноз\n"
        "По каждой из 5 черт — 1-2 строки: черта, куда склоняется (выше среднего / "
        "ниже среднего / не считывается) и КОНКРЕТНО что в тексте на это указывает:\n"
        "• Открытость новому\n"
        "• Добросовестность\n"
        "• Экстраверсия\n"
        "• Доброжелательность\n"
