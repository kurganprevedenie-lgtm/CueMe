...
from config import GEMINI_API_KEY, GEMINI_PROXY, GROQ_API_KEY, OPENROUTER_API_KEY
...
async def rewrite_message_explained(
    ...
    prompt = (
        ...
        "Затем — на «ты», по-человечески: ЧТО изменил и ПОЧЕМУ именно под этого собеседника, "
