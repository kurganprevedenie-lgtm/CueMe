...
async def build_deep_analysis(
    ...
    число, когда доказательств мало:
      ...
      • юмор — пара маркер→реакция, ОБЕ реплики цитатой И обе содержательны
    ...
    prompt = (
        ...
        "содержания. Пример правильного обоснования: «На шутку автора «ты "
        "меня совсем уже не любишь, раз макарошки не варишь» собеседник "
        "ответил «ахахах ну началось» — живо подхватила иронию.» Если пар с "
        "содержательными обеими репликами нет — честно «пар не нашлось, N "
        "шуток автора без явной реакции»>\n"
