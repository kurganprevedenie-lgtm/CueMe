...
CONFLICT_WORDS = [
    "бесит", "заебал", "достал", "обидел", "обиж", "злюсь", "злит",
    "ненавиж", "надоел", "расстроил", "ссор",
    # "ебан" — отдельный от "заебал" корень мата (ебаный/ебаная/ебаные...),
    # та же категория, что уже покрыта заебал/бесит выше.
    "ебан",
]
