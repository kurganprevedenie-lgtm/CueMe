...
4. **Анализ собеседника** (кнопка «🔬 Анализ собеседника»), 5 блоков. Совместимость
   ...
   анализа, термины в вывод не идут, красные флаги приоритизированы по тяжести:
   - Совместимость (0-100) — по доле подхваченных бидов и взаимному самораскрытию
   ...
   - 💚 Зелёные / 🚩 Красные флаги (честно, без выдумывания для симметрии; самый
     тяжёлый паттерн — всегда первым пунктом)
